...
const contatoRoutes = [
    {
        //rota 1
        path: 'contato',
        component: contatos_lista_component_1.ContatosListaComponent //Componente a ser renderizado 
    },
    {
        //rota 2
        path: 'contato/save',
...
ContatoRoutingModule = __decorate([
    core_1.NgModule({
        imports: [
            router_1.RouterModule.forChild(contatoRoutes) // forChild pois e uma rota filha di app-module que recebe o forRoot
        ]
    })
